      ...
      <div class="w-full md:w-2/5 h-screen p-8 md:p-10">
        ...
        <form class="mt-8 lg:mt-16">
          ...
          <div class="text-center mt-3 leading-6">
            ...
            <a class="text-right text-sm text-blue-500 hover:text-blue-700 cursor-pointer" @click="showModal()">
              Tap here for reset
            </a>
            <hr class="mt-3">
            ...
            <p class="text-sm text-gray-700">
              ...
              <nuxt-link to="/register" class=" text-blue-500 hover:text-blue-700 cursor-pointer">Please, create a new one</nuxt-link>
            </p>
          </div>
        </form>
      </div>
      ...
      <div class="bg-white text-center max-w-md p-5 mx-5 rounded-lg">
        <div class="mb-10 flex justify-between items-center">
          <p class="text-xl tracking-wider">
            <img src="../assets/img/bluesmallplane.png" class="w-10 mr-2 inline" alt="logo ankasa">
            Ankasa
          </p>
        ...
        <p class="text-description">
          Forgot your password? Please, enter your email here! You'll get message soon to create a new password
        </p>
